...
## Introduction
Interlock is tracked by RansomLook as an active extortion or ransomware actor. This page is an imported seed profile and should be expanded with additional source-backed reporting.

## Activities and Tactics
Interlock has publicly tracked activity in RansomLook datasets. Additional operational detail should be added here as the profile is curated with higher-confidence reporting.
...
No verified IOC data was imported automatically for Interlock. This section is intentionally reserved for stable, source-backed indicators specific to this actor.
...
## References
1. [RansomLook group profile](https://www.ransomlook.io/api/group/interlock)
