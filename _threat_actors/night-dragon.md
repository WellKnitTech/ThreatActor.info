...
description: "Night Dragon is a threat actor tracked by MISP Galaxy. Additional information pending cataloguing."
...
*Enterprise ATT&CK techniques below are drawn from the merged [Categorized Adversary TTPs](https://github.com/tropChaud/Categorized-Adversary-TTPs) dataset for MITRE group G0014 (YAML `ttps` empty).*
