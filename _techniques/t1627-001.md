...
description_excerpt: |-
  ...
  Geofencing is accomplished by persuading the user
attack_version: '19.0'
---

## Description

Adversaries may use a device’s geographical location to limit certain malicious behaviors. For example, malware operators may limit the distribution of a second stage payload to certain geographic regions. [Lookout eSurv](https://blog.lookout.com/esurv-research) 
