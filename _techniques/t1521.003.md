...
description_excerpt: "Adversaries may use SSL Pinning  to protect the C2 traffic from
  being intercepted and analyzed.\n\nSSL Pinning  is a technique commonly utilized
  by legitimate websites to ensure that encrypted communications are only allowed
  with a pre-defined certificate. If another certificate is "
attack_version: '19.1'
---
