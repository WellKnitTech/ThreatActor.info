...
description_excerpt: |-
  ...
  Authentication cookies are commonly used in web a
attack_version: '19.1'
---

## Description

Adversaries can use stolen session cookies to authenticate to web applications and services. This technique bypasses some multi-factor authentication protocols since the session is already authenticated. [Pass The Cookie](https://wunderwuzzi23.github.io/blog/passthecookie.html) 
...
There have been examples of malware targeting session cookies to bypass multi-factor authentication systems. [Unit 42 Mac Crypto Cookies January 2019](https://unit42.paloaltonetworks.com/mac-malware-steals-cryptocurrency-exchanges-cookies/) 
