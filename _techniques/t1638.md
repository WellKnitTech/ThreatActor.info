...
description_excerpt: "Adversaries may attempt to position themselves between two or
  more networked devices to support follow-on behaviors such as Transmitted Data Manipulation
  or Endpoint Denial of Service.  \n\n \n\nAdversary-in-the-Middle can be achieved
  through several mechanisms. For example, a malicio"
attack_version: '19.0'
---
